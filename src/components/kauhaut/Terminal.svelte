...
<div class="terminal text-background mb-10 flex w-11/12 flex-col rounded p-4">
	<div class="terminal-heading hidden w-full px-2 py-1 font-bold opacity-70 md:flex md:text-2xl">
	...
	{#each terminalData as { status, time, type, info, text }}
		<div class="flex w-full py-1 md:px-2 md:text-2xl">
